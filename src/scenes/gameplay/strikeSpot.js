var StrikeSpot = function(ball, gateHit) {
	...
	if (this.r2Color >= 0 && this.r2Color < 15) {
		this.r2Inc = true;
	}
	else {
		this.r2Inc = false;
	}
	if (this.g1Color >= 0 && this.g1Color < 15) {
		this.g1Inc = true;
	}
	else {
		this.g1Inc = false;
	}
	if (this.g2Color >= 0 && this.g2Color < 15) {
		this.g2Inc = true;
	}
	else {
		this.g2Inc = false;
	}
	if (this.b1Color >= 0 && this.b1Color < 15) {
		this.b1Inc = true;
	}
	else {
		this.b1Inc = false;
	}
	if (this.b2Color >= 0 && this.b2Color < 15) {
		this.b2Inc = true;
	}
	else {
		this.b2Inc = false;
